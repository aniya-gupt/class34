...
function preload()
{
  ...
  food = loadImage('aniya-main/sheild.png');
  rabbit = loadImage('aniya-main/1.png');
  star_img = loadImage('aniya-main/sword.png');
  ...
  blink = loadAnimation("aniya-main/2.png","aniya-main/2.png");
  eat = loadAnimation("aniya-main/3.png" ,"aniya-main/3.png","aniya-main/3.png");
  sad = loadAnimation("aniya-main/4.png","aniya-main/4.png");
